...
*VectorDatabaseApi* | [**listVectorDocuments**](docs/Api/VectorDatabaseApi.md#listvectordocuments) | **GET** /api/v3/organizations/{organisation}/ai/vector-db/collections/{collectionId}/documents | List Documents in Collection
