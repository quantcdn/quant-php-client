...
use QuantClient\Model\V2Rule;

/**
 * V2RuleTest Class Doc Comment
 *
 * @category    Class
 * @description V2Rule
 * @package     QuantClient
 ...
 * @link        https://openapi-generator.tech
 */
class V2RuleTest extends TestCase
{
     ...
     * Test "V2Rule"
     */
    public function testV2Rule()
    {
        $model = new V2Rule();
        $this->assertInstanceOf(V2Rule::class, $model);
    }
