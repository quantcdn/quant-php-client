...
/**
 * V2RuleProxyActionQuantCloudSelection Class Doc Comment
 *
 * @category Class
 ...
 */
class V2RuleProxyActionQuantCloudSelection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V2RuleProxyAction_quant_cloud_selection';
    ...
    */
     ...
     * Sets app
     *
     * @param string|null $app Application name
     *
     * @return self
     */
     ...
     * Sets container
     *
     * @param string|null $container Container name
     *
     * @return self
     */
     ...
     * Sets port
     *
     * @param int|null $port Container port
     *
     * @return self
     */
