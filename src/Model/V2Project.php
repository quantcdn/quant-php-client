 ...
 */
class V2Project implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V2Project';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('write_token', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets machine_name
     *
     * @param string $machine_name Project machine name
     *
     * @return self
     */
     ...
     * Sets write_token
     *
     * @param string|null $write_token Write token for API access
     *
     * @return self
     */
    public function setWriteToken($write_token)
    {
        if (is_null($write_token)) {
            throw new \InvalidArgumentException('non-nullable write_token cannot be null');
        }
