...
/**
 * AiSearchSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class AiSearchSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiSearch_search_request';
    ...
    */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 50)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling AiSearchSearchRequest., must be smaller than or equal to 50.');
        }
