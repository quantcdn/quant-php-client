 ...
 */
class CronRun implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CronRun';
    ...
    public const RUN_TYPE_EXEC = 'EXEC';
    public const RUN_TYPE_CRON = 'CRON';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('run_type', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($run_type)) {
            throw new \InvalidArgumentException('non-nullable run_type cannot be null');
        }
        $allowedValues = $this->getRunTypeAllowableValues();
    ...
    public function setExitCode($exit_code)
    {
        if (is_null($exit_code)) {
            array_push($this->openAPINullablesSetToNull, 'exit_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('exit_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets schedule_name
     *
     * @param string|null $schedule_name schedule_name
     *
     * @return self
     */
