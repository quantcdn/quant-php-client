...
/**
 * Embeddings200ResponseUsage Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class Embeddings200ResponseUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'embeddings_200_response_usage';
    ...
    */
     ...
     * Sets input_tokens
     *
     * @param int $input_tokens Number of tokens in input text(s)
     *
     * @return self
     */
     ...
     * Sets total_tokens
     *
     * @param int $total_tokens Total tokens (same as inputTokens for embeddings)
     *
     * @return self
     */
