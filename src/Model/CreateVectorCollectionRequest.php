...
/**
 * CreateVectorCollectionRequest Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateVectorCollectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createVectorCollection_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Collection name (used for reference)
     *
     * @return self
     */
     ...
     *
     * @param string $embedding_model Embedding model to use. Supported: amazon.titan-embed-text-v2:0, cohere.embed-english-v3, cohere.embed-multilingual-v3
     *
     * @return self
     */
     ...
     * Sets dimensions
     *
     * @param int|null $dimensions Embedding dimensions (default: 1024)
     *
     * @return self
     */
