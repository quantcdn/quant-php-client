...
/**
 * CreateCommandRequest Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateCommandRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCommand_request';
    ...
    */
     ...
     * Sets container_name
     *
     * @param string|null $container_name Target container (defaults to the first container in the task definition)
     *
     * @return self
     */
    public function setContainerName($container_name)
    {
        if (is_null($container_name)) {
            array_push($this->openAPINullablesSetToNull, 'container_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('container_name', $nullablesSetToNull);
            if ($index !== FALSE) {
