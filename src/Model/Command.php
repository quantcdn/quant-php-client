 ...
 */
class Command implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Command';
    ...
    */
    ...
    public function setTargetContainerName($target_container_name)
    {
        if (is_null($target_container_name)) {
            throw new \InvalidArgumentException('non-nullable target_container_name cannot be null');
        }
