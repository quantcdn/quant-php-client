...
/**
 * AiSearchIngestPagesRequestPagesInner Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class AiSearchIngestPagesRequestPagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiSearch_ingestPages_request_pages_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pre_processed', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['pre_processed'];
    }

    /**
     * Sets pre_processed
     *
     * @param bool|null $pre_processed pre_processed
     *
     * @return self
     */
    public function setPreProcessed($pre_processed)
    {
        if (is_null($pre_processed)) {
            throw new \InvalidArgumentException('non-nullable pre_processed cannot be null');
        }
        $this->container['pre_processed'] = $pre_processed;
