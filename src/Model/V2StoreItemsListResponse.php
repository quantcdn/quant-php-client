...
/**
 * V2StoreItemsListResponse Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class V2StoreItemsListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V2StoreItemsListResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param string[]|null $data List of item keys
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Cursor for next page of results
     *
     * @return self
     */
