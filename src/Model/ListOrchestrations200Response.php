...
/**
 * ListOrchestrations200Response Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class ListOrchestrations200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listOrchestrations_200_response';
    ...
    {
        $this->setIfExists('orchestrations', $data ?? [], null);
    ...
    */
     ...
     * Sets orchestrations
     *
     * @param object[]|null $orchestrations orchestrations
     *
     * @return self
     */
    public function setOrchestrations($orchestrations)
    {
        if (is_null($orchestrations)) {
            throw new \InvalidArgumentException('non-nullable orchestrations cannot be null');
        }
