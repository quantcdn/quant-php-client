...
class CreateSlackBotRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets system_prompt
     *
     * @param string $system_prompt System prompt for the backing AI agent
     *
     * @return self
     */
     ...
     * Sets model_id
     *
     * @param string $model_id AI model identifier
     *
     * @return self
     */
    ...
    public function setTemperature($temperature)
    {
        ...
        if (($temperature > 2)) {
            throw new \InvalidArgumentException('invalid value for $temperature when calling CreateSlackBotRequest., must be smaller than or equal to 2.');
        }
        if (($temperature < 0)) {
            throw new \InvalidArgumentException('invalid value for $temperature when calling CreateSlackBotRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxTokens($max_tokens)
    {
        ...
        if (($max_tokens < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_tokens when calling CreateSlackBotRequest., must be bigger than or equal to 1.');
        }
