...
/**
 * RestoreFilesystemRequest Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class RestoreFilesystemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'restoreFilesystem_request';
    ...
    */
     ...
     *
     * @param bool $acknowledge_dataloss Must be true. tar extraction overwrites same-named files in the target EFS in place; pre-existing files not in the archive are preserved.
     *
     * @return self
     */
