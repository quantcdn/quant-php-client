...
/**
 * AiSearchUpdateSettingsRequest Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class AiSearchUpdateSettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiSearch_updateSettings_request';
    ...
    {
        $this->setIfExists('public_access', $data ?? [], null);
    ...
    */
     ...
     * Sets public_access
     *
     * @param object|null $public_access public_access
     *
     * @return self
     */
    public function setPublicAccess($public_access)
    {
        if (is_null($public_access)) {
            throw new \InvalidArgumentException('non-nullable public_access cannot be null');
        }
     ...
     * Sets rate_limits
     *
     * @param object|null $rate_limits rate_limits
     *
     * @return self
     */
