...
/**
 * GetScalingPolicyResponse Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class GetScalingPolicyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetScalingPolicyResponse';
    ...
    protected static $setters = [
        ...
        'resource_label' => 'setResourceLabel'
    ];
    ...
    protected static $getters = [
        ...
        'resource_label' => 'getResourceLabel'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('resource_label', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets policy_name
     *
     * @param string|null $policy_name Name of the underlying Application Auto Scaling policy.
     *
     * @return self
     */
    ...
    {
        return $this->container['resource_label'];
    }

    /**
     * Sets resource_label
     *
     * @param string|null $resource_label ALB ResourceLabel for RPS policies (target group identifier).
     *
     * @return self
     */
    public function setResourceLabel($resource_label)
    {
        if (is_null($resource_label)) {
            array_push($this->openAPINullablesSetToNull, 'resource_label');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('resource_label', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['resource_label'] = $resource_label;
