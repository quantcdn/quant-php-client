...
class ListTasks200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets tasks
     *
     * @return \QuantClient\Model\ListTasks200ResponseTasksInner[]|null
     */
     ...
     * Sets tasks
     *
     * @param \QuantClient\Model\ListTasks200ResponseTasksInner[]|null $tasks tasks
     *
     * @return self
     */
     ...
     * Sets task_ids
     *
     * @param string[]|null $task_ids Task IDs (only with dependsOn filter)
     *
     * @return self
     */
     ...
     * Sets depends_on
     *
     * @param string|null $depends_on The queried task ID (only with dependsOn filter)
     *
     * @return self
     */
