...
/**
 * SetScalingPolicyRequest Class Doc Comment
 *
 * @category Class
 * @package  QuantClient
 * @author   OpenAPI Generator team
 ...
 */
class SetScalingPolicyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetScalingPolicyRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('scale_in_cooldown_seconds', $data ?? [], 300);
        $this->setIfExists('scale_out_cooldown_seconds', $data ?? [], 60);
    }
    ...
    */
     ...
     * Sets metric
     *
     * @param string $metric Metric to track for scaling.
     *
     * @return self
     */
     ...
     * Sets target_value
     *
     * @param float $target_value Target value. Percentage for CPU/Memory; req/sec per task for RPS.
     *
     * @return self
     */
     ...
     *
     * @param int|null $scale_in_cooldown_seconds Cooldown (seconds) before another scale-in can start.
     *
     * @return self
     */
     ...
     *
     * @param int|null $scale_out_cooldown_seconds Cooldown (seconds) before another scale-out can start.
     *
     * @return self
     */
